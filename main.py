...
from multiview_detector.models.ca_detector import CA_Detector
from multiview_detector.models.ca_sa_detector import CA_SA_Detector
from multiview_detector.models.sa_detector import SA_Detector
...
def main(args):
    ...
    if "wildtrack" in args.dataset:
        data_path = os.path.expanduser("/workspace/Data/Wildtrack")
    ...
    elif args.variant == "CA":
        model = CA_Detector(train_set, args.arch)
    elif args.variant == "CA+SA":
        model = CA_SA_Detector(train_set, args.arch)
    elif args.variant == "SA":
        model = SA_Detector(train_set, args.arch)
    ...
    # logging
    logdir = (
        f"logs/{args.dataset}_frame/{args.variant}/"
